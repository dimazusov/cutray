...
AccessManager all annotations of a class
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
AccessManager one annotation of a class
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
AccessManager all annotations of a method
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
AccessManager one annotation of a method
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
AccessManager all annotations of a property
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
AccessManager one annotation of a property
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
