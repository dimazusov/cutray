...
Added way to access the underlying Command#from() method's 'indexBy' parameter when using EntityRepository#createQueryBuilder()
...
## Query, Command and NativeQuery parameters *BC break*
